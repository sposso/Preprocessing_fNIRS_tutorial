...
2. The scalp coupling index value is calculated and used to identify optodes that were not well connected to the scalp. The scalp coupling threshold value was used to remove channels with a rejection criterion of < 0.8.
...
6. Filtering was applied to the signal (0.02-0.4 Hz) to remove slow drifts in the signal and components related to heart rate.
7. The signal enhancement method introduced [here](https://pubmed.ncbi.nlm.nih.gov/19945536)  is applied.
